...
function ResultCharts({ results, fileName = "" }) {
  ...
  async function downloadPDF() {
    ...
    pdf.text(
      "Generated by Logititles · logititles.com · Results are indicative and based on uploaded job title data. Salary benchmarks are estimates and should not be treated as official market salary data.",
      margin, pageH - 16
    );
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 32 }}>
        ...
        {salaryData.length > 0 && (
          <div>
            ...
            <div style={{ fontSize: 11, color: C.textMuted, marginBottom: 12 }}>Indicative estimates only · roles with salary data · n ≥ 10 per domain</div>
            <ResponsiveContainer width="100%" height={260}>
