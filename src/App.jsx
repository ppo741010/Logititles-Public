...
function ResultCharts({ results, fileName = "" }) {
  ...
  async function downloadPDF() {
    ...
    pdf.text(
      `Generated by Logititles · logititles.com · Results are indicative and based on uploaded job title data. Salary benchmarks are shown only for domains with at least ${MIN_SALARY_SAMPLE_SIZE} salary records and should not be treated as official market salary data.`,
      margin, pageH - 16
    );
  ...
  return (
    <Card style={{ padding: "20px 24px" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 32 }}>
        ...
        {salaryData.length > 0 && (
          <div>
            <div style={{ fontSize: 12, fontWeight: 600, color: C.textMuted, marginBottom: 4, textTransform: "uppercase", letterSpacing: "0.05em" }}>Estimated Median Salary by Domain (NZD)</div>
            <div style={{ fontSize: 11, color: C.textMuted, marginBottom: 12 }}>Indicative estimates only · shown for domains with at least {MIN_SALARY_SAMPLE_SIZE} salary records</div>
            <ResponsiveContainer width="100%" height={260}>
